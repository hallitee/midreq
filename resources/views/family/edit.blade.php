...
<div id="page-wrapper">
            ...
            <!-- /.row -->
            <div class="row">
{!! Form::open(['action' => array('FamilyController@update', $fam->id),'method'=>'PUT']) !!}
					<div class="col-lg-8 col-md-8 col-md-offset-3">
						...
						{!! Form::text('famName',$fam->name,array('class' => 'input-md form-control', 'id'=>'lnkName')); !!}
						</div>	
					</div>
						<div id="div_id_select" class="form-group required">
						<label for="id_select"  class="control-label col-md-4  requiredField">Group<span class="asteriskField"></span> </label>
						<div class="controls col-md-5 "  style="margin-bottom: 10px">
						{!! Form::select('famGrp',$grp,$fam->group_id,array( 'class' => 'input-md form-control', 'id'=>'lnkUrl')); !!}
						</div>	
					</div>			
						<div id="div_id_select" class="form-group required">
